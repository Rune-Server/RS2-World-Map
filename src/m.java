    ...
    private static void aeg(n arg0)
    {
        ...
        while(flag20) 
        {
            ...
            for(int i4 = 0; i4 < k4; i4++)
            {
                ...
                ael(arg0.ban[i4], arg0.bba[i4], arg0.bbb[i4], arg0.bam[i4], byte8, i, j4);
                arg0.bbc[i4] = byte8;
            }
            ...
            for(int l5 = ai2[i8 - ai1[j7]]; l5 != i5;)
                if(l5 == 0 || l5 == 1)
                {
                    ...
                    do
                    {
                        ...
                        int j8;
                        byte byte10;
                        for(j8 = aen(k7, arg0); j8 > ai[k7]; j8 = j8 << 1 | byte10)
                        {
                            k7++;
                            byte10 = aej(arg0);
                        }
...
label0:
    ...
    private static void ael(int arg0[], int arg1[], int arg2[], byte arg3[], int arg4, int arg5, int arg6)
    {
        int i = 0;
