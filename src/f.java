...
public class f extends e
{
    ...
    private void ahk(Font arg0, FontMetrics arg1, char arg2, int arg3, boolean arg4, EventHandler arg5)
    {
        ...
        int ai[] = new int[i * l];
        PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, i, l, ai, 0, i);
        try
        {
...
label3:
    ...
    public f(int arg0, boolean arg1, EventHandler arg2)
    {
        ...
        for(int i = 0; i < 95; i++)
            ahk(font, fontmetrics, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"\243$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".charAt(i), i, false, arg2);
        ...
        if(arg1 && akj)
        {
            ...
            for(int j = 0; j < 95; j++)
                ahk(font1, fontmetrics1, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"\243$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".charAt(j), j, false, arg2);
            ...
            if(!akj)
            {
                ...
                akj = false;
                for(int k = 0; k < 95; k++)
                    ahk(font1, fontmetrics1, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"\243$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".charAt(k), k, true, arg2);
    ...
    private void aia(int arg0[], byte arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, 
            int arg7, int arg8)
    {
        for(int i = -arg6; i < 0; i++)
        {
            for(int j = -arg5; j < 0; j++)
            {
                ...
                if(k > 30)
                {
                    ...
                    {
                        int l = arg0[arg4];
                        arg0[arg4++] = ((arg2 & 0xff00ff) * k + (l & 0xff00ff) * (256 - k) & 0xff00ff00) + ((arg2 & 0xff00) * k + (l & 0xff00) * (256 - k) & 0xff0000) >> 8;
                    }
                } else
                {
                    arg4++;
    ...
    private void aie(int arg0, int arg1, int arg2, int arg3, byte arg4[], boolean arg5)
    {
        ...
        if(k > 0 && l > 0)
            if(arg5)
                aia(e.bbe, arg4, arg3, i1, j1, k, l, k1, l1);
            else
                aif(e.bbe, arg4, arg3, i1, j1, k, l, k1, l1);
    }

    private void aif(int arg0[], byte arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, 
            int arg7, int arg8)
    {
        try
        {
